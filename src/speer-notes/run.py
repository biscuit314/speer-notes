...
def main():
    parser = argparse.ArgumentParser('speer-notes', 'HypermeaService API')
    parser.add_argument('--host', help='The host to bind to.  Default is "0.0.0.0" which lets you call the API from a remote location.  Use "localhost" to only allow calls from this location', default='0.0.0.0')
